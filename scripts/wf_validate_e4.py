#!/usr/bin/env python3
"""Valida un mapa de traduccion de e1 SIN aplicarlo a e4.json.
...
recs={r["id"]:r for r in json.load(open(os.path.join(ROOT,"translated_text","e4.json"),encoding="utf-8"))}
